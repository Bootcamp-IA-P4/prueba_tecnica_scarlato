...
class CategoriaAdmin(admin.ModelAdmin):
    list_display = ['nombre', 'descripcion', 'activa', 'orden']
    list_editable = ['activa', 'orden']
    list_filter = ['activa']
    search_fields = ['nombre', 'descripcion']
    prepopulated_fields = {'slug': ('nombre',)}
    readonly_fields = ['total_recetas']
...
class TagAdmin(admin.ModelAdmin):
    list_display = ['nombre', 'color', 'total_recetas']
    search_fields = ['nombre']
    prepopulated_fields = {'slug': ('nombre',)}
    
    def total_recetas(self, obj):
        """Mostrar total de recetas con este tag"""
        return obj.receta_set.count()
    total_recetas.short_description = 'Total Recetas'
...
class ValoracionAdmin(admin.ModelAdmin):
    list_display = ['receta', 'puntuacion_stars', 'comentario_corto', 'fecha']
    list_filter = ['puntuacion', 'fecha']
    search_fields = ['receta__titulo', 'comentario']
    readonly_fields = ['fecha']
